...
export default function CountryCard(props) {
  ...
  return (
    ...
    <div className="card-body bgNav changeBack  rounded-bottom shadow-sm py-4 ps-4">
      <h6 className="card-title mb-3 fw-bold" onClick={(e)=>handleCountryClick(e)}>{countryName}</h6>
